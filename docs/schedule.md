...
There are four chapters, or broad themes, that we will cover in this course:

1. single cell genomics
2. cell identity
3. trajectory inference and fate potential
4. regulatory networks

!!!warning "Access to videos and slides listed here is available to current students"

    The lecture videos and slides can only be accessed after authenticating via [Hopkin's SSO](https://my.jh.edu/html/myjh.html)


| What| Date     | Chapter | Topic               | video                                                                                            | slides             | other |
| ------ | -------- | --------|-------------------- | -------------------------------------------------------------------------------------------------------- | ------------------------- |------|
...
| Lecture 12    | 03-10-26 | 3       | Intro to Trajectory Inference (TI) | [pre-recorded video](https://jh.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=f4008eda-bf94-4ace-b85a-b408010f75a1) | [slides](https://jhu.instructure.com/courses/112401/files/folder/slides?preview=17429979) |
...
| Lecture 18     | 04-09-26 | 4       | GRNs from single cell omics data | [pre-recorded video](https://jh.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=a54ccd2e-5f39-4e97-9a08-b42700f8e18a) | [slides](https://jhu.instructure.com/courses/112401/files/folder/slides?preview=16914893) |
| Lecture 19     | 04-14-26 | 4       | Computational approaches to cell fate engineering | - | [slides]() |
